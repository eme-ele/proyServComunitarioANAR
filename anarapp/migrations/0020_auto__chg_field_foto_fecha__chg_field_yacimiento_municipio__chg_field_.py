...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Foto.fecha'
        db.alter_column('anarapp_foto', 'fecha', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Yacimiento.municipio'
        db.alter_column('anarapp_yacimiento', 'municipio_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(null=True, to=orm['anarapp.Municipio']))

        # Changing field 'SupervisadoPor.fecha'
        db.alter_column('anarapp_supervisadopor', 'fecha', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'FotografiaYac.fecha'
        db.alter_column('anarapp_fotografiayac', 'fecha', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'LlenadoPor.fecha'
        db.alter_column('anarapp_llenadopor', 'fecha', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ObtencionInfo.fecha'
        db.alter_column('anarapp_obtencioninfo', 'fecha', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Foto.fecha'
        raise RuntimeError("Cannot reverse this migration. 'Foto.fecha' and its values cannot be restored.")

        # Changing field 'Yacimiento.municipio'
        db.alter_column('anarapp_yacimiento', 'municipio_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['anarapp.Municipio']))

        # Changing field 'SupervisadoPor.fecha'
        db.alter_column('anarapp_supervisadopor', 'fecha', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'FotografiaYac.fecha'
        db.alter_column('anarapp_fotografiayac', 'fecha', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'LlenadoPor.fecha'
        db.alter_column('anarapp_llenadopor', 'fecha', self.gf('django.db.models.fields.DateField')(null=True))

        # User chose to not deal with backwards NULL issues for 'ObtencionInfo.fecha'
        raise RuntimeError("Cannot reverse this migration. 'ObtencionInfo.fecha' and its values cannot be restored.")
