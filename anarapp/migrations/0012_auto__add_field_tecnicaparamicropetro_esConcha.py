...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TecnicaParaMicroPetro.esConcha'
        db.add_column('anarapp_tecnicaparamicropetro', 'esConcha',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TecnicaParaMicroPetro.esConcha'
        db.delete_column('anarapp_tecnicaparamicropetro', 'esConcha')
