...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OtrosValPiedra.texto'
        db.add_column('anarapp_otrosvalpiedra', 'texto',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.codigo'
        db.add_column('anarapp_bibyacimiento', 'codigo',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.titulo'
        db.add_column('anarapp_bibyacimiento', 'titulo',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.autor'
        db.add_column('anarapp_bibyacimiento', 'autor',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.ano'
        db.add_column('anarapp_bibyacimiento', 'ano',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.institucion'
        db.add_column('anarapp_bibyacimiento', 'institucion',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.conDibujo'
        db.add_column('anarapp_bibyacimiento', 'conDibujo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.archivo'
        db.add_column('anarapp_bibyacimiento', 'archivo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibYacimiento.esFotografia'
        db.add_column('anarapp_bibyacimiento', 'esFotografia',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.escolor'
        db.add_column('anarapp_bibyacimiento', 'escolor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.esBlancoYNegro'
        db.add_column('anarapp_bibyacimiento', 'esBlancoYNegro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.esDiapositiva'
        db.add_column('anarapp_bibyacimiento', 'esDiapositiva',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.esPapel'
        db.add_column('anarapp_bibyacimiento', 'esPapel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.esDigital'
        db.add_column('anarapp_bibyacimiento', 'esDigital',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibYacimiento.esNegativo'
        db.add_column('anarapp_bibyacimiento', 'esNegativo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'BibYacimiento.tipoMapa'
        db.add_column('anarapp_bibyacimiento', 'tipoMapa',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Bibliografia.autor'
        db.delete_column('anarapp_bibliografia', 'autor')

        # Deleting field 'Bibliografia.institucion'
        db.delete_column('anarapp_bibliografia', 'institucion')

        # Deleting field 'Bibliografia.conDibujo'
        db.delete_column('anarapp_bibliografia', 'conDibujo')

        # Deleting field 'Bibliografia.codigo'
        db.delete_column('anarapp_bibliografia', 'codigo')

        # Deleting field 'Bibliografia.titulo'
        db.delete_column('anarapp_bibliografia', 'titulo')

        # Deleting field 'Bibliografia.ano'
        db.delete_column('anarapp_bibliografia', 'ano')

        # Adding field 'OtrosValYac.texto'
        db.add_column('anarapp_otrosvalyac', 'texto',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Deleting field 'OtrosValores.texto'
        db.delete_column('anarapp_otrosvalores', 'texto')
        ...
        # Adding field 'BibPiedra.archivo'
        db.add_column('anarapp_bibpiedra', 'archivo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BibPiedra.esFotografia'
        db.add_column('anarapp_bibpiedra', 'esFotografia',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.escolor'
        db.add_column('anarapp_bibpiedra', 'escolor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.esBlancoYNegro'
        db.add_column('anarapp_bibpiedra', 'esBlancoYNegro',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.esDiapositiva'
        db.add_column('anarapp_bibpiedra', 'esDiapositiva',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.esPapel'
        db.add_column('anarapp_bibpiedra', 'esPapel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.esDigital'
        db.add_column('anarapp_bibpiedra', 'esDigital',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BibPiedra.esNegativo'
        db.add_column('anarapp_bibpiedra', 'esNegativo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding field 'BibPiedra.tipoMapa'
        db.add_column('anarapp_bibpiedra', 'tipoMapa',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('anarapp_fotobibliografia', (
            ...
            ('descripcion', self.gf('anarapp.models.CharField')(max_length=65000)),
        ...
        db.create_table('anarapp_fotobibpiedra', (
            ...
            ('piedra', self.gf('django.db.models.fields.related.ForeignKey')(related_name='FotoBibPiedra', to=orm['anarapp.Piedra'])),
        ))
        ...
        db.create_table('anarapp_fotobibyac', (
            ('fotobibliografia_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['anarapp.FotoBibliografia'], unique=True, primary_key=True)),
            ('yacimiento', self.gf('django.db.models.fields.related.ForeignKey')(related_name='FotoBibYac', to=orm['anarapp.Yacimiento'])),
        ))
        db.send_create_signal('anarapp', ['FotoBibYac'])

        # Deleting field 'OtrosValPiedra.texto'
        db.delete_column('anarapp_otrosvalpiedra', 'texto')

        # Deleting field 'BibYacimiento.codigo'
        db.delete_column('anarapp_bibyacimiento', 'codigo')

        # Deleting field 'BibYacimiento.titulo'
        db.delete_column('anarapp_bibyacimiento', 'titulo')

        # Deleting field 'BibYacimiento.autor'
        db.delete_column('anarapp_bibyacimiento', 'autor')

        # Deleting field 'BibYacimiento.ano'
        db.delete_column('anarapp_bibyacimiento', 'ano')

        # Deleting field 'BibYacimiento.institucion'
        db.delete_column('anarapp_bibyacimiento', 'institucion')

        # Deleting field 'BibYacimiento.conDibujo'
        db.delete_column('anarapp_bibyacimiento', 'conDibujo')

        # Deleting field 'BibYacimiento.archivo'
        db.delete_column('anarapp_bibyacimiento', 'archivo')

        # Deleting field 'BibYacimiento.esFotografia'
        db.delete_column('anarapp_bibyacimiento', 'esFotografia')

        # Deleting field 'BibYacimiento.escolor'
        db.delete_column('anarapp_bibyacimiento', 'escolor')

        # Deleting field 'BibYacimiento.esBlancoYNegro'
        db.delete_column('anarapp_bibyacimiento', 'esBlancoYNegro')

        # Deleting field 'BibYacimiento.esDiapositiva'
        db.delete_column('anarapp_bibyacimiento', 'esDiapositiva')

        # Deleting field 'BibYacimiento.esPapel'
        db.delete_column('anarapp_bibyacimiento', 'esPapel')

        # Deleting field 'BibYacimiento.esDigital'
        db.delete_column('anarapp_bibyacimiento', 'esDigital')

        # Deleting field 'BibYacimiento.esNegativo'
        db.delete_column('anarapp_bibyacimiento', 'esNegativo')

        # Deleting field 'BibYacimiento.descripcion'
        db.delete_column('anarapp_bibyacimiento', 'descripcion')

        # Deleting field 'BibYacimiento.tipoMapa'
        db.delete_column('anarapp_bibyacimiento', 'tipoMapa')

        # Adding field 'Bibliografia.autor'
        db.add_column('anarapp_bibliografia', 'autor',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'Bibliografia.institucion'
        db.add_column('anarapp_bibliografia', 'institucion',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'Bibliografia.conDibujo'
        db.add_column('anarapp_bibliografia', 'conDibujo',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'Bibliografia.codigo'
        db.add_column('anarapp_bibliografia', 'codigo',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'Bibliografia.titulo'
        db.add_column('anarapp_bibliografia', 'titulo',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'Bibliografia.ano'
        db.add_column('anarapp_bibliografia', 'ano',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Deleting field 'OtrosValYac.texto'
        db.delete_column('anarapp_otrosvalyac', 'texto')

        # Adding field 'OtrosValores.texto'
        db.add_column('anarapp_otrosvalores', 'texto',
        ...
        # Deleting field 'BibPiedra.archivo'
        db.delete_column('anarapp_bibpiedra', 'archivo')

        # Deleting field 'BibPiedra.esFotografia'
        db.delete_column('anarapp_bibpiedra', 'esFotografia')

        # Deleting field 'BibPiedra.escolor'
        db.delete_column('anarapp_bibpiedra', 'escolor')

        # Deleting field 'BibPiedra.esBlancoYNegro'
        db.delete_column('anarapp_bibpiedra', 'esBlancoYNegro')

        # Deleting field 'BibPiedra.esDiapositiva'
        db.delete_column('anarapp_bibpiedra', 'esDiapositiva')

        # Deleting field 'BibPiedra.esPapel'
        db.delete_column('anarapp_bibpiedra', 'esPapel')

        # Deleting field 'BibPiedra.esDigital'
        db.delete_column('anarapp_bibpiedra', 'esDigital')

        # Deleting field 'BibPiedra.esNegativo'
        db.delete_column('anarapp_bibpiedra', 'esNegativo')

        # Deleting field 'BibPiedra.descripcion'
        db.delete_column('anarapp_bibpiedra', 'descripcion')

        # Deleting field 'BibPiedra.tipoMapa'
        db.delete_column('anarapp_bibpiedra', 'tipoMapa')
