...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Yacimiento.estado'
        db.delete_column('anarapp_yacimiento', 'estado')

        # Deleting field 'Yacimiento.municipio'
        db.delete_column('anarapp_yacimiento', 'municipio')

        # Adding field 'Yacimiento.estado_fk'
        db.add_column('anarapp_yacimiento', 'estado_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='EstadoYac', null=True, to=orm['anarapp.Estado']),
                      keep_default=False)

        # Adding field 'Yacimiento.municipio_fk'
        db.add_column('anarapp_yacimiento', 'municipio_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='MunicipioYac', null=True, to=orm['anarapp.Municipio']),
                      keep_default=False)

        # Deleting field 'Piedra.estado'
        db.delete_column('anarapp_piedra', 'estado')

        # Adding field 'Piedra.estado_fk'
        db.add_column('anarapp_piedra', 'estado_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='EstadoPied', null=True, to=orm['anarapp.Estado']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Yacimiento.estado'
        db.add_column('anarapp_yacimiento', 'estado',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Adding field 'Yacimiento.municipio'
        db.add_column('anarapp_yacimiento', 'municipio',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000),
                      keep_default=False)

        # Deleting field 'Yacimiento.estado_fk'
        db.delete_column('anarapp_yacimiento', 'estado_fk_id')

        # Deleting field 'Yacimiento.municipio_fk'
        db.delete_column('anarapp_yacimiento', 'municipio_fk_id')
        ...
        # Deleting field 'Piedra.estado_fk'
        db.delete_column('anarapp_piedra', 'estado_fk_id')
    ...
    models = {
        ...
        'anarapp.piedra': {
            ...
            'estado_fk': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'EstadoPied'", 'null': 'True', 'to': "orm['anarapp.Estado']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'anarapp.yacimiento': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            'estado_fk': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'EstadoYac'", 'null': 'True', 'to': "orm['anarapp.Estado']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'municipio_fk': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'MunicipioYac'", 'null': 'True', 'to': "orm['anarapp.Municipio']"}),
            'nombre': ('anarapp.models.CharField', [], {'max_length': '65000'}),
