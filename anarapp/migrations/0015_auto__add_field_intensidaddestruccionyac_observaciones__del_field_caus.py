...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntensidadDestruccionYac.observaciones'
        db.add_column('anarapp_intensidaddestruccionyac', 'observaciones',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Deleting field 'CausasDestruccionYac.observaciones'
        db.delete_column('anarapp_causasdestruccionyac', 'observaciones')


    def backwards(self, orm):
        # Deleting field 'IntensidadDestruccionYac.observaciones'
        db.delete_column('anarapp_intensidaddestruccionyac', 'observaciones')

        # Adding field 'CausasDestruccionYac.observaciones'
        db.add_column('anarapp_causasdestruccionyac', 'observaciones',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)
