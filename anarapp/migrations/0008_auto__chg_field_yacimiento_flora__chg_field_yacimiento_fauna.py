...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Yacimiento.flora'
        db.alter_column('anarapp_yacimiento', 'flora', self.gf('django.db.models.fields.CharField')(max_length=1500))

        # Changing field 'Yacimiento.fauna'
        db.alter_column('anarapp_yacimiento', 'fauna', self.gf('django.db.models.fields.CharField')(max_length=1500))

    def backwards(self, orm):

        # Changing field 'Yacimiento.flora'
        db.alter_column('anarapp_yacimiento', 'flora', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Yacimiento.fauna'
        db.alter_column('anarapp_yacimiento', 'fauna', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        'anarapp.yacimiento': {
            ...
            'numPiedrasYacimientoColocadas': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'numPiedrasYacimientoGrabadas': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'numPiedrasYacimientoOriginal': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'numPiedrasYacimientoPintadas': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
