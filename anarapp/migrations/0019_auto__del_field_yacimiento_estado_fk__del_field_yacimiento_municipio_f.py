...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('anarapp_yacimiento', 'estado_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='EstadoYac', null=True, to=orm['anarapp.Estado'], blank=True),
                      keep_default=False)

        # Adding field 'Yacimiento.municipio_fk'
        db.add_column('anarapp_yacimiento', 'municipio_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='MunicipioYac', null=True, to=orm['anarapp.Municipio'], blank=True),
                      keep_default=False)

        # Deleting field 'Yacimiento.estado'
        db.delete_column('anarapp_yacimiento', 'estado_id')

        # Deleting field 'Yacimiento.municipio'
        db.delete_column('anarapp_yacimiento', 'municipio_id')
    ...
    models = {
        ...
        'anarapp.yacimiento': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'municipio': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'MunicipioYac'", 'null': 'True', 'to': "orm['anarapp.Municipio']"}),
            'nombre': ('anarapp.models.CharField', [], {'max_length': '65000'}),
