...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EstadoConserYac.porErosionParSevera'
        db.delete_column('anarapp_estadoconseryac', 'porErosionParSevera')

        # Deleting field 'EstadoConserYac.otros'
        db.delete_column('anarapp_estadoconseryac', 'otros')

        # Deleting field 'EstadoConserYac.esInmediato'
        db.delete_column('anarapp_estadoconseryac', 'esInmediato')

        # Deleting field 'EstadoConserYac.porVandalismo'
        db.delete_column('anarapp_estadoconseryac', 'porVandalismo')

        # Deleting field 'EstadoConserYac.porErosionExtSevera'
        db.delete_column('anarapp_estadoconseryac', 'porErosionExtSevera')

        # Deleting field 'EstadoConserYac.porErosionParModerada'
        db.delete_column('anarapp_estadoconseryac', 'porErosionParModerada')

        # Deleting field 'EstadoConserYac.porExtraccionFamiliar'
        db.delete_column('anarapp_estadoconseryac', 'porExtraccionFamiliar')

        # Deleting field 'EstadoConserYac.dosAno'
        db.delete_column('anarapp_estadoconseryac', 'dosAno')

        # Deleting field 'EstadoConserYac.porErosionExtModerada'
        db.delete_column('anarapp_estadoconseryac', 'porErosionExtModerada')

        # Deleting field 'EstadoConserYac.observaciones'
        db.delete_column('anarapp_estadoconseryac', 'observaciones')

        # Deleting field 'EstadoConserYac.porExtraccionMayor'
        db.delete_column('anarapp_estadoconseryac', 'porExtraccionMayor')

        # Deleting field 'EstadoConserYac.esDeTiempo'
        db.delete_column('anarapp_estadoconseryac', 'esDeTiempo')

        # Deleting field 'EstadoConserYac.porAsentamientoHumand'
        db.delete_column('anarapp_estadoconseryac', 'porAsentamientoHumand')

        # Deleting field 'EstadoConserYac.unAno'
        db.delete_column('anarapp_estadoconseryac', 'unAno')

        # Deleting field 'EstadoConserYac.porObraMedianoPlazo'
        db.delete_column('anarapp_estadoconseryac', 'porObraMedianoPlazo')

        # Deleting field 'EstadoConserYac.cuatroAno'
        db.delete_column('anarapp_estadoconseryac', 'cuatroAno')

        # Deleting field 'EstadoConserYac.porObraLargoPlazo'
        db.delete_column('anarapp_estadoconseryac', 'porObraLargoPlazo')

        # Deleting field 'EstadoConserYac.porErosion'
        db.delete_column('anarapp_estadoconseryac', 'porErosion')

        # Deleting field 'EstadoConserYac.porNivelacion'
        db.delete_column('anarapp_estadoconseryac', 'porNivelacion')

        # Deleting field 'EstadoConserYac.porObraCortoPlazo'
        db.delete_column('anarapp_estadoconseryac', 'porObraCortoPlazo')

        # Deleting field 'EstadoConserYac.mas'
        db.delete_column('anarapp_estadoconseryac', 'mas')

        # Deleting field 'EstadoConserYac.cincoAno'
        db.delete_column('anarapp_estadoconseryac', 'cincoAno')

        # Deleting field 'EstadoConserYac.tresAno'
        db.delete_column('anarapp_estadoconseryac', 'tresAno')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EstadoConserYac.porErosionParSevera'
        db.add_column('anarapp_estadoconseryac', 'porErosionParSevera',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.otros'
        db.add_column('anarapp_estadoconseryac', 'otros',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'EstadoConserYac.esInmediato'
        db.add_column('anarapp_estadoconseryac', 'esInmediato',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porVandalismo'
        db.add_column('anarapp_estadoconseryac', 'porVandalismo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porErosionExtSevera'
        db.add_column('anarapp_estadoconseryac', 'porErosionExtSevera',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porErosionParModerada'
        db.add_column('anarapp_estadoconseryac', 'porErosionParModerada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porExtraccionFamiliar'
        db.add_column('anarapp_estadoconseryac', 'porExtraccionFamiliar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.dosAno'
        db.add_column('anarapp_estadoconseryac', 'dosAno',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porErosionExtModerada'
        db.add_column('anarapp_estadoconseryac', 'porErosionExtModerada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.observaciones'
        db.add_column('anarapp_estadoconseryac', 'observaciones',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porExtraccionMayor'
        db.add_column('anarapp_estadoconseryac', 'porExtraccionMayor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.esDeTiempo'
        db.add_column('anarapp_estadoconseryac', 'esDeTiempo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porAsentamientoHumand'
        db.add_column('anarapp_estadoconseryac', 'porAsentamientoHumand',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.unAno'
        db.add_column('anarapp_estadoconseryac', 'unAno',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porObraMedianoPlazo'
        db.add_column('anarapp_estadoconseryac', 'porObraMedianoPlazo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.cuatroAno'
        db.add_column('anarapp_estadoconseryac', 'cuatroAno',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porObraLargoPlazo'
        db.add_column('anarapp_estadoconseryac', 'porObraLargoPlazo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porErosion'
        db.add_column('anarapp_estadoconseryac', 'porErosion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porNivelacion'
        db.add_column('anarapp_estadoconseryac', 'porNivelacion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.porObraCortoPlazo'
        db.add_column('anarapp_estadoconseryac', 'porObraCortoPlazo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.mas'
        db.add_column('anarapp_estadoconseryac', 'mas',
                      self.gf('anarapp.models.CharField')(default='', max_length=65000, blank=True),
                      keep_default=False)

        # Adding field 'EstadoConserYac.cincoAno'
        db.add_column('anarapp_estadoconseryac', 'cincoAno',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoConserYac.tresAno'
        db.add_column('anarapp_estadoconseryac', 'tresAno',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
