...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Yacimiento.numPiedrasYacimientoColocadas'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoColocadas', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Yacimiento.numPiedrasYacimientoOriginal'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoOriginal', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Yacimiento.numPiedrasYacimientoPintadas'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoPintadas', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Yacimiento.numPiedrasYacimientoGrabadas'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoGrabadas', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Yacimiento.numPiedrasYacimientoColocadas'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoColocadas', self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2013, 5, 3, 0, 0)))

        # Changing field 'Yacimiento.numPiedrasYacimientoOriginal'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoOriginal', self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2013, 5, 3, 0, 0)))

        # Changing field 'Yacimiento.numPiedrasYacimientoPintadas'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoPintadas', self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2013, 5, 3, 0, 0)))

        # Changing field 'Yacimiento.numPiedrasYacimientoGrabadas'
        db.alter_column('anarapp_yacimiento', 'numPiedrasYacimientoGrabadas', self.gf('django.db.models.fields.IntegerField')(default=datetime.datetime(2013, 5, 3, 0, 0)))
    ...
    models = {
        ...
        'anarapp.yacimiento': {
            ...
            'destruccionPotencialSitio': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anarapp.DestruccionPotencialSitio']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'fauna': ('django.db.models.fields.CharField', [], {'max_length': '1500'}),
            'flora': ('django.db.models.fields.CharField', [], {'max_length': '1500'}),
            ...
            'mecanismosObtencionInformacion': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['anarapp.MecanismoObtencionInformacion']", 'symmetrical': 'False', 'blank': 'True'}),
            'municipio': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'numPiedrasYacimientoColocadas': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'numPiedrasYacimientoGrabadas': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'numPiedrasYacimientoOriginal': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'numPiedrasYacimientoPintadas': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'numeroPlano': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'observacionesDestruccion': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'observacionesExposicion': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            ...
            'otrasNotas': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'otrosConstitucionYacimiento': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'otrosValoresSitio': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'pais': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
